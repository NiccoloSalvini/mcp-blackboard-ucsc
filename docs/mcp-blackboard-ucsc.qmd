...
Il codice è pubblico su GitHub con **licenza MIT**: <https://github.com/NiccoloSalvini/mcp-blackboard-ucsc>. Il repository contiene il codice, i test, la documentazione e il sorgente di questa nota. **Non contiene** credenziali (il file che le custodisce è escluso dal controllo di versione fin dal primo giorno), né dati di studenti, né materiali di correzione, né esami: anche negli esempi dei test nomi e matricole sono inventati. Gli identificativi dei corsi che compaiono negli esempi sono quelli dei miei corsi e non danno accesso ad alcunché senza un'applicazione registrata dall'Ateneo.
...
Da parte mia, i prossimi passi sono: completare la verifica delle scritture sul corso 2026-27 con lo script descritto; costruire la banca domande e generare da lì il primo intermedio di ottobre; usare il flusso dei compiti sulle prime esercitazioni dell'autunno e misurare il tempo di correzione risparmiato; provare il caricamento su SVE al primo appello utile, che è l'unico passaggio non ancora verificato.
